...
class MainContentViewController: UIViewController {
    ...
    var currentVO = WeatherCurrentVO()            // 현재 날씨 정보 VO
    var hourlyVOList = Array<WeatherHourlyVO>()   // 시간별 날씨 정보 VO List
    var dailyVOList = Array<WeatherDailyVO>()     // 요일별 날씨 정보 VO List
